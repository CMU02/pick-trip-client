        ...
        {REGIONS.map((region) => {
          ...
          return (
            <button
              ...
              className={
                selected
                  ? "tap-target rounded-full border border-primary bg-accent px-3 py-1.5 text-sm font-medium text-accent-foreground"
                  : "tap-target rounded-full border border-border bg-card px-3 py-1.5 text-sm hover:border-primary/40"
              }
            >
