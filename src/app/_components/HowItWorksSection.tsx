...
const CONTROL_CLASS =
  "relative grid h-7 w-7 place-items-center rounded-full text-[oklch(0.45_0.02_30)] transition-colors [&_svg]:drop-shadow-[0_1px_2px_oklch(1_0_0_/_0.7)] hover:bg-white hover:text-[oklch(0.24_0.02_30)] focus-visible:bg-white focus-visible:text-[oklch(0.24_0.02_30)] before:absolute before:-inset-2 before:content-['']";
                  ...
                  >
                    <div className="overflow-hidden rounded-[22px] border border-border bg-[oklch(0.975_0.012_30)]">
                      <div className="flex h-8 items-center gap-1.5 border-b border-border px-3">
                        <span className="h-2 w-2 rounded-full bg-[oklch(0.9_0.02_30)]" />
                        <span className="h-2 w-2 rounded-full bg-[oklch(0.9_0.02_30)]" />
                        <span className="h-2 w-2 rounded-full bg-[oklch(0.9_0.02_30)]" />
                      </div>
